...
set(HYBRID_GGPO_LIB_INC_SERVICES
        "headers/service/HybridGGPOServiceProvider.h"
        "headers/service/IGameStateService.h"
        "headers/service/IHybridGGPOService.h"
        "headers/service/IInputPredictionStrategyService.h"
)

set(HYBRID_GGPO_LIB_SRC_SERVICES
...
source_group("Services" FILES ${HYBRID_GGPO_LIB_INC_SERVICES} ${HYBRID_GGPO_LIB_SRC_SERVICES})
...
set(HYBRID_GGPO_LIB_SRC
        ...
        ${HYBRID_GGPO_LIB_INC_SERVICES}
        ${HYBRID_GGPO_LIB_SRC_SERVICES}
