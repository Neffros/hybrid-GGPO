...
void
HybridP2PSession::AddRemotePlayer(char* ip,
    uint16 port,
    int queue)
{
    /*
...
GGPOErrorCode HybridP2PSession::AddSpectator(char* ip,
    uint16 port)
{
...
GGPOErrorCode
HybridP2PSession::DoPoll(int timeout)
{
    if (!_sync.InRollback()) {
        _poll.Pump(0);
...
int HybridP2PSession::Poll2Players(int current_frame)
{
    int i;
...
int HybridP2PSession::PollNPlayers(int current_frame)
{
...
GGPOErrorCode
HybridP2PSession::AddPlayer(GGPOPlayer* player,
...
GGPOErrorCode
HybridP2PSession::AddLocalInput(GGPOPlayerHandle player,
    void* values,
    int size)
{
    int queue;
...
GGPOErrorCode
HybridP2PSession::SyncInput(void* values,
    int size,
...
GGPOErrorCode
HybridP2PSession::IncrementFrame(void)
{
    Log("End of frame (%d)...\n", _sync.GetFrameCount());
...
void
HybridP2PSession::PollUdpProtocolEvents(void)
{
...
void
HybridP2PSession::OnUdpProtocolPeerEvent(UdpProtocol::Event& evt, int queue)
{
...
void
HybridP2PSession::OnUdpProtocolSpectatorEvent(UdpProtocol::Event& evt, int queue)
{
...
void
HybridP2PSession::OnUdpProtocolEvent(UdpProtocol::Event& evt, GGPOPlayerHandle handle)
{
    GGPOEvent info;
 ...
 */
GGPOErrorCode
HybridP2PSession::DisconnectPlayer(GGPOPlayerHandle player)
{
    int queue;
    GGPOErrorCode result;
...
void
HybridP2PSession::DisconnectPlayerQueue(int queue, int syncto)
{
    GGPOEvent info;
...
GGPOErrorCode
HybridP2PSession::GetNetworkStats(GGPONetworkStats* stats, GGPOPlayerHandle player)
{
    int queue;
    GGPOErrorCode result;
...
GGPOErrorCode
HybridP2PSession::SetFrameDelay(GGPOPlayerHandle player, int delay)
{
    int queue;
    GGPOErrorCode result;
...
GGPOErrorCode
HybridP2PSession::SetDisconnectTimeout(int timeout)
{
...
GGPOErrorCode
HybridP2PSession::SetDisconnectNotifyStart(int timeout)
{
...
GGPOErrorCode
HybridP2PSession::PlayerHandleToQueue(GGPOPlayerHandle player, int* queue)
{
...
void
HybridP2PSession::OnMsg(sockaddr_in& from, UdpMsg* msg, int len)
{
    for (int i = 0; i < _num_players; i++) {
...
void
HybridP2PSession::CheckInitialSync()
{
    int i;
